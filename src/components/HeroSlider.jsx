...
const slides = [
  {
    ...
    cta1: { text: 'Get a Free Quote →', href: '#quote-form' },
    cta2: { text: 'View Our Projects', href: '/projects-s1.html' },
    img: h1,
  },
  {
    ...
    cta2: { text: 'Our Process', href: '#process' },
    img: h2,
  },
  {
    ...
    cta1: { text: 'Start Your Project', href: '#quote-form' },
          ...
          <div className="container hero__split">
            <div className="hero__content">
              ...
              <div className={`hero__actions reveal delay-3${i === active ? ' visible' : ''}`}>
                <a href={slide.cta1.href} className="btn-primary hero__cta1">
                  {slide.cta1.text}
                  <ArrowRight size={16} />
                </a>
                <a href={slide.cta2.href} className="btn-outline hero__cta2">
                  {slide.cta2.text}
