    ...
    <section id="quote-form" className="quote-section" ref={sectionRef}>
      <div className="container quote-inner">
        <div className="quote-info reveal-left">
          ...
          <h2 className="section-heading quote-heading">Start Your Project Today</h2>
          ...
          <ul className="quote-benefits">
            {['Free site survey included', 'Detailed, itemised quotation', 'No-obligation consultation', 'Response within 2 business hours'].map((b, i) => (
        ...
        <div className="quote-form-wrap reveal-right">
          {submitted ? (
            <div className="quote-success" role="alert">
              <div className="quote-success__icon"><CheckCircle size={48} strokeWidth={1.5} /></div>
              ...
              <button className="btn-primary quote-success__btn" onClick={handleReset}>Submit Another Request</button>
            </div>
          ) : (
            <form className="quote-form" onSubmit={handleSubmit} noValidate aria-label="Quote request form">
              <div className="form-row">
                <div className={`form-group${errors.name ? ' form-group--error' : ''}`}>
                  <label htmlFor="q-name">Full Name <span className="req" aria-hidden="true">*</span></label>
                  <div className="form-input-wrap">
                    <User size={16} className="form-icon" />
                    <input id="q-name" name="name" type="text" autoComplete="name" placeholder="Your full name" value={form.name} onChange={handleChange} aria-required="true" />
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className="form-input-wrap">
                    ...
                    <input id="q-company" name="company" type="text" placeholder="Optional" value={form.company} onChange={handleChange} />
                  </div>
                </div>
              </div>
              ...
              <div className="form-row">
                <div className={`form-group${errors.phone ? ' form-group--error' : ''}`}>
                  <label htmlFor="q-phone">Phone Number <span className="req" aria-hidden="true">*</span></label>
                  <div className="form-input-wrap">
                    <Phone size={16} className="form-icon" />
                    <input id="q-phone" name="phone" type="tel" autoComplete="tel" placeholder="10-digit mobile number" value={form.phone} onChange={handleChange} aria-required="true" />
                  </div>
                ...
                <div className="form-group">
                  ...
                  <div className="form-input-wrap">
                    ...
                    <input id="q-email" name="email" type="email" autoComplete="email" placeholder="Optional" value={form.email} onChange={handleChange} />
                  </div>
                </div>
              </div>
              ...
              <div className="form-row">
                <div className={`form-group${errors.service ? ' form-group--error' : ''}`}>
                  <label htmlFor="q-service">Service Required <span className="req" aria-hidden="true">*</span></label>
                  <div className="form-input-wrap form-input-wrap--select">
                    <Wrench size={16} className="form-icon" />
                    <select id="q-service" name="service" value={form.service} onChange={handleChange} aria-required="true">
                ...
                <div className="form-group">
                  ...
                  <div className="form-input-wrap">
                    ...
                    <input id="q-location" name="location" type="text" placeholder="e.g. Koramangala, Whitefield" value={form.location} onChange={handleChange} />
                  </div>
                </div>
              </div>
              ...
              <div className="form-group form-group--full">
                ...
                <div className="form-input-wrap form-input-wrap--textarea">
                  ...
                  <textarea id="q-desc" name="description" rows={4} placeholder="Describe your project, measurements, or any specific requirements..." value={form.description} onChange={handleChange} />
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                <div className="form-input-wrap">
                  ...
                  <input id="q-date" name="visitDate" type="date" min={new Date().toISOString().split('T')[0]} value={form.visitDate} onChange={handleChange} />
                </div>
              </div>

              <button type="submit" className={`form-submit${loading ? ' form-submit--loading' : ''}`} disabled={loading}>
                {loading ? <><span className="form-submit__spinner" aria-hidden="true" />Sending Request...</> : <>Submit Request<Send size={16} /></>}
              </button>
            </form>
          )}
        </div>
