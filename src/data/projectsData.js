...
export const projectsByYear = [
  {
    year: '2025+',
    projects: [
      { name: 'Godrej Woodscapes',        category: 'Residential',   photos: 8,  img: img(0) },
      { name: 'Godrej Azure',             category: 'Residential',   photos: 1,  img: img(1) },
      { name: 'Casagrand Flamingo',       category: 'Residential',   photos: 2,  img: img(2) },
      { name: 'Casagrand Windsor',        category: 'Residential',   photos: 2,  img: img(3) },
      { name: 'Casagrand Attapur',        category: 'Residential',   photos: 1,  img: img(4) },
      { name: 'Brigade Ivory',            category: 'Residential',   photos: 3,  img: img(5) },
      { name: 'Godrej MSR',               category: 'Residential',   photos: 4,  img: img(6) },
      { name: 'Godrej Splendour',         category: 'Residential',   photos: 1,  img: img(7) },
      { name: 'Atmos & Aura',             category: 'Residential',   photos: 2,  img: img(8) },
      { name: 'Assetz Sora & Saki',       category: 'Residential',   photos: 1,  img: img(9) },
      { name: 'Assetz Soho and Sky',      category: 'Commercial',    photos: 2,  img: img(10) },
      { name: 'Assetz Canvas & Cove',     category: 'Residential',   photos: 3,  img: img(11) },
      { name: 'Lodha Mirabelle',          category: 'Residential',   photos: 4,  img: img(0) },
    ],
  },
  {
    year: '2024',
    projects: [
      { name: 'Godrej Kokapet',                category: 'Residential',  photos: 29, img: img(1) },
      { name: 'Godrej Park Retreat Clubhouse', category: 'Commercial',   photos: 12, img: img(2) },
      { name: 'Godrej Ananda',                 category: 'Residential',  photos: 15, img: img(3) },
      { name: 'Godrej Regal Pavillion',        category: 'Residential',  photos: 3,  img: img(4) },
      { name: 'Assetz Bloom and Dell',         category: 'Residential',  photos: 9,  img: img(5) },
      { name: 'Lodha Mirabelle',               category: 'Residential',  photos: 4,  img: img(6) },
      { name: 'Casagrand Aquene',              category: 'Residential',  photos: 2,  img: img(7) },
      { name: 'Brigade Goldspire',             category: 'Residential',  photos: 1,  img: img(8) },
      { name: 'Mahindra Eden',                 category: 'Residential',  photos: 1,  img: img(9) },
      { name: 'Ren & Rei',                     category: 'Commercial',   photos: 2,  img: img(10) },
      { name: 'Assetz Avathi',                 category: 'Residential',  photos: 1,  img: img(11) },
      { name: 'L&W Construction',              category: 'Commercial',   photos: 1,  img: img(0) },
      { name: 'Inspira World',                 category: 'Commercial',   photos: 1,  img: img(1) },
      { name: 'Godrej RDL-Hosa Road',          category: 'Residential',  photos: 1,  img: img(2) },
      { name: 'Phenix',                        category: 'Commercial',   photos: 1,  img: img(3) },
    ],
  },
  {
    year: '2023',
    projects: [
      { name: 'Godrej Avenues',           category: 'Residential',   photos: 5,  img: img(4) },
      { name: 'National Public School',   category: 'Institutional', photos: 2,  img: img(5) },
      { name: 'Brigade Orchards Banyan',  category: 'Residential',   photos: 1,  img: img(6) },
      { name: 'Brigade Atmosphere',       category: 'Residential',   photos: 1,  img: img(7) },
      { name: 'Bloom Hotel',              category: 'Hospitality',   photos: 1,  img: img(8) },
  ...
  },
  {
    year: '2022',
    projects: [
      { name: 'La Palmera',          category: 'Residential',  photos: 26, img: img(10) },
      { name: 'Godrej 24',           category: 'Residential',  photos: 1,  img: img(11) },
      { name: 'Assetz Soho and Sky', category: 'Commercial',   photos: 2,  img: img(0) },
      { name: 'Assetz 38 & Banyan',  category: 'Residential',  photos: 2,  img: img(1) },
      { name: 'Ascent Hosur',        category: 'Commercial',   photos: 2,  img: img(2) },
    ],
  },
  {
    year: '2021',
    projects: [
      { name: 'Soul & Soil',                 category: 'Residential',  photos: 20, img: img(3) },
      { name: 'Sun & Sanctum',               category: 'Residential',  photos: 6,  img: img(4) },
      { name: 'Brigade Ramaiah Hospital',    category: 'Healthcare',   photos: 4,  img: img(5) },
      { name: 'Brigade Pavillion Villas',    category: 'Residential',  photos: 3,  img: img(6) },
      { name: 'Assetz 18 & Oak',             category: 'Residential',  photos: 1,  img: img(7) },
    ],
  },
  {
    year: '2020',
    projects: [
      { name: 'Corporate Office', category: 'Commercial',  photos: 1, img: img(8) },
      { name: 'Biryani Zone',     category: 'Hospitality', photos: 1, img: img(9) },
      { name: '63 Degree',        category: 'Commercial',  photos: 1, img: img(10) },
    ],
  },
  {
    year: '2019',
    projects: [
      { name: 'Assetz Marq PH-2',             category: 'Residential',   photos: 37, img: img(11) },
      { name: 'Orchids International School', category: 'Institutional', photos: 1,  img: img(0) },
      { name: '63 Degree',                    category: 'Commercial',    photos: 1,  img: img(1) },
    ],
  },
  {
    year: '2018',
    projects: [
      { name: 'Earth & Essence',    category: 'Residential', photos: 8, img: img(2) },
      { name: 'Assetz Canvas & Cove', category: 'Residential', photos: 3, img: img(3) },
      { name: 'Leaves & Livrs',     category: 'Residential', photos: 1, img: img(4) },
      { name: 'Here & Now',         category: 'Commercial',  photos: 1, img: img(5) },
    ],
  },
  {
    year: '2017',
    projects: [
      { name: 'Assetz 18 & Oak', category: 'Residential',   photos: 1, img: img(6) },
      { name: 'Supreme Solar',   category: 'Industrial',    photos: 1, img: img(7) },
      { name: 'Chrysalis',       category: 'Institutional', photos: 1, img: img(8) },
    ],
  },
  {
    year: '2016',
    projects: [
      { name: 'Assetz Lumos',     category: 'Residential', photos: 1, img: img(9) },
      { name: 'Assetz Marq PH-1', category: 'Residential', photos: 9, img: img(10) },
    ],
  },
  {
    year: '2015',
    projects: [
      { name: 'Assetz East Point', category: 'Residential', photos: 1, img: img(11) },
      { name: 'Global Tech Park',  category: 'Commercial',  photos: 1, img: img(0)  },
      { name: 'Crompton Office',   category: 'Commercial',  photos: 1, img: img(1)  },
      { name: 'L & W Builders',    category: 'Commercial',  photos: 1, img: img(2)  },
    ],
  },
  {
    year: '2014',
    projects: [
      { name: 'Assetz 27 Park Avenue',     category: 'Residential',   photos: 1, img: img(3) },
      { name: 'Ramanashree',               category: 'Hospitality',   photos: 1, img: img(4) },
      { name: 'Emmvee Solar',              category: 'Industrial',    photos: 1, img: img(5) },
      { name: 'Eco Space Infrastructures', category: 'Commercial',    photos: 1, img: img(6) },
      { name: 'Vibgyor',                   category: 'Institutional', photos: 2, img: img(7) },
    ],
  },
  {
    year: '2008–2013',
    projects: [
      { name: 'ITC Gardenia Bengaluru', category: 'Hospitality',  photos: 1,  img: img(8) },
      { name: 'Residential Projects',  category: 'Residential',  photos: 18, img: img(9) },
    ],
  },
].map(yearGroup => ({
  ...yearGroup,
